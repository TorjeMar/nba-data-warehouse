...
from _v2.sources.nba.tmp import get_player_index, BASE_HEADERS, ctx
...
output_directory = '_data/000_raw/nba/player_index/data'
ctx.error_log = '_data/000_raw/nba/player_index/errors.jsonl'

print(f'Starting download of player index data for {len(args)} season and season type combinations\n')
    ...
    while attempt > 0:
        ...
        if data.status_code == 200:
            ...
            envelope = build_provenance_envelope(
                ...
                path_processing_script='_data/000_raw/nba/player_index/download.py',
