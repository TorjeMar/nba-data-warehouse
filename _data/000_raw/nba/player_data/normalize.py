...
def normalize_player_data(entry: dict, json_path: str) -> dict:
    data = entry['data']['props']['pageProps']['player']
    info = data['info']
...
if __name__ == '__main__':
    ...
    input_data = '_data/000_raw/nba/player_data/data'
    output_directory = '_data/000_raw/nba/player_data/normalized'
    ...
    for path in input_paths:
        ...
        for index, entry in enumerate(data):
            ...
            if not 'player' in content:
                continue
            
            normalized_data = normalize_player_data(entry, path)
    ...
    envelope = build_provenance_envelope(
        ...
        path_processing_script='_data/000_raw/nba/player_data/normalize.py',
